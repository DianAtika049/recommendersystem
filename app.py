...
class InputExpander:
    PROBLEM_EXPANSION = {
        ...
        'rusak': ['damaged hair', 'repair'],
        'kusam': ['dull hair', 'shine'],
...
class UserInputVectorizer:
    def __init__(self, tfidf_vectorizer_path, fasttext_finetuned_path, products_df=None):
        ...
        self.fasttext_model = KeyedVectors.load_word2vec_format(
            fasttext_finetuned_path, binary=False
        )
...
class HaircareRecommender:
    def __init__(self,
        ...
        self.category_mapping = {
            ...
            'tonic': 'hair tonic', 'hair tonic': 'hair tonic', 'hair_tonic': 'hair tonic',
    ...
    with st.container():
        ...
        with col1:
            ...
            hair_problems = st.multiselect(
                ...
                ["ketombe", "rontok", "kering", "berminyak", "bercabang", "rusak", "kusam"],
            ...
            categories_raw = st.multiselect(
                "Pilih kategori",
                ["shampoo", "conditioner", "hair mask", "hair serum", "hair oil", "hair tonic"],
